...
export const DEVELOPER_SUITE_CONFIGS = [
  ...
  { slug: 'uuid-generator', name: 'UUID Generator', description: 'Generate random UUID v4 identifiers.', process: async () => dp.generateUuid() },
  ...
  { slug: 'cron-expression-generator', name: 'Cron Expression Generator', description: 'Generate common cron expressions.', options: [{ value: 'hourly', label: 'Every hour' }, { value: 'daily', label: 'Daily' }, { value: 'weekly', label: 'Weekly' }, { value: 'monthly', label: 'Monthly' }], process: async ({ option }) => dp.generateCron(option) },
  ...
  { slug: 'dev-lorem-ipsum', name: 'Lorem Ipsum Generator', description: 'Generate placeholder text.', numberField: true, defaultNumber: 3, process: async ({ numberOpt }) => tp.generateLoremIpsum(numberOpt) },
