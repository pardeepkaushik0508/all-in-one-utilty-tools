...
export default function AdminLoginPage({ onLogin, error, loading = false }) {
  ...
  return (
    <div className="admin-login-shell">
      <Head>
        <title>Admin Sign In — UtilityTools</title>
      ...
      <div className="admin-login-wrap">
        ...
        <div className="admin-login-card card">
          <header className="mb-6">
            ...
            <p className="mt-2 text-sm text-muted">Sign in with your admin account to manage content.</p>
          </header>
