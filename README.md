...
Image generation may require billing enabled in [Google AI Studio](https://aistudio.google.com/) — the free tier has limited or no quota for `gemini-2.5-flash-image`.
